...
public class DebugLogger {
    private static final String LOG_PATH = "D:\\AplikasiTrading\\debug-546b38.log";
    private static final String FALLBACK_LOG_PATH = "debug-546b38.log";
    private static final String DB_URL = "jdbc:sqlite:D:\\AplikasiTrading\\data\\trading.db";
    private static final String SESSION_ID = "546b38";
